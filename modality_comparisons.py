...
results_folder_dbn = "/orange/cruzalmeida/pvaldeshernandez/projects/shands-brainage/results_dbn"

# Read data
df0 = pd.read_csv(results_folder_dbn + "test_predictions_dbn.csv")
...
df1 = pd.read_csv(f"{results_folder}/test_predictions.csv")
...
for pad_var in ["PAD", "corrected_PAD"]:
    ...
    summary_df.to_csv(f"{results_folder}/summary-{pad_var}.csv")
    ...
    export_test_results(
        result,
        anova_contrast,
        f"{results_folder}/anova-{pad_var}.csv",
        test_type="f",
    )
    ...
    t_test = export_test_results(
        result,
        anova_contrast,
        f"{results_folder}/comparison-{pad_var}.csv",
        test_type="t",
    ...
    export_test_results(
        result,
        mae_contrast,
        f"{results_folder}/maes-{pad_var}.csv",
        test_type="t",
    ...
    export_test_results(
        result,
        anova_contrast,
        f"{results_folder}/anova-slope-{pad_var}.csv",
        test_type="f",
    )
    ...
    export_test_results(
        result,
        contrast_matrix,
        f"{results_folder}/anova-slope-pairwise-{pad_var}.csv",
        test_type="t",
        names=pair_names,
    ...
    export_test_results(
        result,
        anova_contrast,
        f"{results_folder}/anova-slope_zero-{pad_var}.csv",
        test_type="f",
    )
    ...
    export_test_results(
        result,
        anova_contrast[:, :-1],
        f"{results_folder}/anova-slope_zero-each-{pad_var}.csv",
        test_type="t",
